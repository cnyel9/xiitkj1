...
const Schedule = () => {
    ...
    piketGroup = [
        ["Novandio", "Arif", "Rafli", "Nazwa", "Novi", "Fani"],
        ["Nero", "Agustian", "Azam", "Chesya", "Neysca", "Larasati"],
        ["Maulana", "Dimas", "Hafidh", "Indri", "Husna", "Juliani"],
        ["Zeanuri", "Alfa", "Ibnu", "Ana", "Icha", "Azzahra"],
        ["Levi", "David", "Irfan", "Diana", "Eriska", "Merlina"],
        ["Efendi", "Fajar", "Maximus", "Rehan", "Resti", "Sesilia", "Tria"],
    ]
            ...
            <div className="lg:flex lg:justify-center lg:gap-32 lg:mb-10 lg:mt-16 ">
                <div className="text-white flex flex-col justify-center items-center mt-8 md:mt-3 overflow-y-hidden">
                    ...
                    <div data-aos="fade-up" data-aos-duration="400">
                        {TodayComponent ? (
                            <React.Suspense fallback={<p>Tunggu Sebentar...</p>}>
                                <TodayComponent />
                            </React.Suspense>
                        ) : (
